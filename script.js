...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.add-btn').addEventListener('click', addFilm);
});
    ...
    films.forEach(film => {
        ...
        filmCard.innerHTML = `
            <div class="film-poster">
                ...
                <button class="delete-btn" onclick="window.deleteFilmHandler(${film.id})" title="Удалить фильм">
...
// Глобальная функция для удаления (чтобы работала из HTML)
window.deleteFilmHandler = function(filmId) {
    deleteFilm(filmId);
};
